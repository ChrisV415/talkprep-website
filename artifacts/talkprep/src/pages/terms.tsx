      ...
      <article className="legal-page">
        <div className="container" style={{ maxWidth: "680px" }}>
          ...
          <div className="legal-body">
            ...
            <h2>Your account</h2>
            <p>You must provide accurate information when creating your account. You are responsible for maintaining the security of your account and for all activity that occurs under it. Notify us immediately at <a href="mailto:hello@talkprep.co">hello@talkprep.co</a> if you suspect unauthorised access.</p>
            ...
            <h2>Refunds</h2>
            <p>
              We offer a 7-day money-back guarantee on all paid plans. If you are not satisfied within 7 days of your first payment, contact us at <a href="mailto:hello@talkprep.co">hello@talkprep.co</a> and we will refund you in full. After 7 days, payments are non-refundable except where required by law.
            </p>
            ...
            <h2>Contact</h2>
            <p>Questions about these terms? Email <a href="mailto:hello@talkprep.co">hello@talkprep.co</a>.</p>
          </div>
        </div>
      </article>
      <SiteFooter />
